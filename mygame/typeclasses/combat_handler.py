...
class CombatHandler(DefaultScript):
    ...
    def at_script_creation(self):
        ...
        self.interval = 60   # two minute timeout
    ...
    def add_character(self, character):
        ...
        self.db.turn_actions[dbref] = [("hit", character, None),
    ...
    def end_turn(self):
        ...
        """
        zklog.zkprint("resolve_combatbef")
        ...
        if len(self.db.characters) < 2:
            ...
            for character in self.db.characters.values():
                zklog.zkprint(['self.db',self.db])
                zklog.zkprint(["character",character])
